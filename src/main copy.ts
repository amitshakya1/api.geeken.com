...
async function bootstrap() {
  ...
  // Admin API Swagger document
  const adminDoc = SwaggerModule.createDocument(app, baseConfig, {
    include: [AdminModule],
    deepScanRoutes: true,
  });
  ...
  // Website API Swagger document
  const websiteDoc = SwaggerModule.createDocument(app, baseConfig, {
