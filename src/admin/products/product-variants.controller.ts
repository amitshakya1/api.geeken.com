...
export class ProductVariantsController {
    ...
    @ApiResponse({ status: 200, description: 'Product variant stock updated successfully' })
    @Permissions('update_product_variant')
    ...
    @ApiResponse({ status: 200, description: 'Product variant set as default successfully' })
    @Permissions('update_product_variant')
    ...
    @ApiResponse({ status: 200, description: 'Product variant status updated successfully' })
    @Permissions('update_product_variant')
