...
export class ProductVariantsService {
  ...
  async update(
    ...
    console.log('ProductVariantsService.update called with:', { id, updateProductVariantDto });
    ...
    console.log('Update data after removing fileIds and amenityIds:', updateData);
