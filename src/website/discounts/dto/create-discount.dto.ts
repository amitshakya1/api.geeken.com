...
export class CreateDiscountDto {
  ...
  @ApiPropertyOptional({
    ...
    example: ["uuid1", "uuid2"],
    description:
      "Array of product UUIDs that user must buy (for buy_x_get_y types)",
  })
  @IsOptional()
  @IsArray()
  @IsUUID("4", { each: true })
  ...
  @ApiPropertyOptional({
    ...
    example: ["uuid3", "uuid4"],
    description:
      "Array of product UUIDs that user will get free (for buy_x_get_y_free type)",
  })
  @IsOptional()
  @IsArray()
  @IsUUID("4", { each: true })
  ...
  @ApiPropertyOptional({
    example: 2,
    description: "Required for buy_x_get_y types",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 1,
    description: "Maximum times a single user can use this discount",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 2,
    description: "Optional cap for how many times buy_x_get_y can apply",
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
